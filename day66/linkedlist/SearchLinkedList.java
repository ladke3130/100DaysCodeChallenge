/*Definition :-To solve this problem, we will traverse through the list using a node current. 
  Current points to head and start comparing searched node data with current node data. 
