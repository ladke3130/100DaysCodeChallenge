/*Definition :-Matrix is simply a two-dimensional array. So the goal is to deal with fixed indices at which elements are present and 
to perform operations on indexes such that elements on the addressed should be 
swapped in such a manner it should lookout as the matrix is rotated. Here we will be discussing two methods in dealing with indices.
  Test case :-Input:
7    8    9
10   11   12
2    3    4
